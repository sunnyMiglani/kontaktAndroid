 ...
 * helper methods.
 */
public class UnityBeaconIntent extends IntentService {
    ...
    public UnityBeaconIntent() {
        super("UnityBeaconIntent");
    }
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, UnityBeaconIntent.class);
